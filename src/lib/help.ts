...
const HELP_BY_PATH: Record<string, HelpTopic> = {
  "/dashboard": {
    ...
    steps: [
      ...
      "Arriba y en el gráfico usan el mismo periodo: flechas, Semana/Mes/Año y los selectores mueven toda la vista de Inicio.",
  ...
  "/transactions": {
    ...
    steps: [
      ...
      "Arriba ves el total de gastos del periodo; al filtrar por ingresos, transferencias u otro tipo, el total se actualiza.",
      "Al filtrar por categoría, las opciones se agrupan por espacio (Personal y compartidos).",
      "Puedes marcar un movimiento como recurrente y, si quieres, activar recordatorio para avisarte este mes.",
