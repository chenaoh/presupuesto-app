  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <button type="button" className="btn btn-ghost text-sm" onClick={() => setMoveOpen(true)}>
          Aportar / retirar
        </button>
      </div>
      ...
      <Modal open={moveOpen} onClose={() => setMoveOpen(false)} title="Aportar / retirar">
        <form onSubmit={onMove} className="grid gap-2 sm:grid-cols-2">
          ...
          <div>
            ...
            >
              <option value="savings_contribution">Aportar</option>
              <option value="savings_withdrawal">Retirar</option>
            </select>
          </div>
          <div>
